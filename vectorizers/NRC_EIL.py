...
class NRC_EIL_VectorMaker:
    def __init__(self, use_intensity = False):
        if use_intensity:
            fileEmotion = "vectorizers/NRC-Emotion-Intensity-Lexicon-v1.txt"
        else:
            fileEmotion = "vectorizers/NRC-emotion-lexicon-wordlevel-alphabetized-v0.92.txt"
